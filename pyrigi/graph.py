...
class Graph(nx.Graph):
    ...
    @classmethod
    @doc_category("Class methods")
    def from_vertices(cls, vertices: Iterable[Vertex]) -> Graph:
        """
    ...
    @classmethod
    @doc_category("Class methods")
    def CompleteOnVertices(cls, vertices: Iterable[Vertex]) -> Graph:
        """
    ...
    def single_NAC_coloring(
        ...
        ----------
        """
        return single_NAC_coloring(graph=self, algorithm=algorithm)
    ...
    def single_cartesian_NAC_coloring(
        ...
        to improve performance for some graph classes.
        """
        return single_cartesian_NAC_coloring(self, algorithm)
